...
from imageops import XImage,make_image
...
class egface:    
    ...
    def reconstructfaces(self,selectedfacesnum):        
        ...
        try:
            ...
            print "some problem removing dir :",inst.message        
        mkdir(recondir)
        print "made:",recondir
        ...
        for x in range(numimgs):
            ...
            imgdata=phinew[x]           
            make_image(imgdata,imgname,(self.bundle.wd,self.bundle.ht),True)
            
        for x in range(numimgs):
            filename=recondir+"/reconx"+str(x)+".png"
            imgdata=xnew[x]
            make_image(imgdata,filename,(self.bundle.wd,self.bundle.ht),True)
    ...
    def createEigenimages(self,eigenspace):                
        ...
        for x in range(numimgs):
            ...
            make_image(eigenspace[x],imgname,(self.bundle.wd,self.bundle.ht))
